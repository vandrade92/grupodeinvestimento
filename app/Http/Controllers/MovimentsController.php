...
class MovimentsController extends Controller
{
    ...
    public function storeApplication(Request $request)
    {
         ...
         session()->flash('success', [
             'success'    => true,
             'messages'   => 'Aplicação no valor de R$'.$movimento->value.' no produto '. $movimento->product->name.' realizado com sucesso',
           ]);
    ...
    public function storeGetBack(Request $request)
    {
         ...
         session()->flash('success', [
             'success'    => true,
             'messages'   => 'Seu regaste no valor de R$'.$movimento->value.' no produto '. $movimento->product->name.' realizado com sucesso',
           ]);
